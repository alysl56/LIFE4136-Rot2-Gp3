...
#SBATCH --job-name=bowtie_map_all
...
bowtie2 -x /share/BioinfMSc/Bill_resources/Tbrucei/fastq/Group3/bowtie_index/index/bowtie_index -U *.fq.gz -N 1 -p 6 -S /share/BioinfMSc/Bill_resources/Tbrucei/fastq/Group3/mapped/allmapped.sam
