...
#SBATCH --job-name=htseq-count_fat
...
htseq-count /share/BioinfMSc/Bill_resources/Tbrucei/fastq/Group3/mapped/fatmapped.sam /share/BioinfMSc/Bill_resources/Tbrucei/fastq/Group3/ref/ref.gff
