...
We used - [part2_averaged.R](Project2/part2_averaged.R) script which used the - [averaged1](Project2/averaged1) file. This produced the .tsv files which we used for gene ontology analysis
